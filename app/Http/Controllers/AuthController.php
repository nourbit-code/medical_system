...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        return back()->withErrors(['email' => 'The provided details are incorrect.'])->onlyInput('email');
    }
    ...
    {
        $data = $request->validate(['name' => 'required|string|max:255', 'email' => 'required|email|unique:users', 'password' => 'required|confirmed|min:6', 'role' => 'required|in:doctor,patient']);
