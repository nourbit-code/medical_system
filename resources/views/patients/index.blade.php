...
<td>
<a href="{{ route('patients.show',$p) }}" class="btn btn-sm btn-info">View</a> <a href="{{ route('patients.edit',$p) }}" class="btn btn-sm btn-warning">Edit</a>
...
@endforelse</table>{{ $patients->links() }}</div>
@endsection
