        ...
        <div class="col-lg-7">
            <div class="card p-4">
                ...
                <div class="row g-3 mt-1">
                    ...
                    <div class="col-md-7">
                        ...
                        <select id="gender" name="gender" class="form-select" required>
                            ...
                            <option value="{{ $gender }}" @selected(old('gender', $user->patient->gender) ===
                                $gender)>{{ ucfirst($gender) }}</option>
                            @endforeach
                        </select>
                ...
                <div class="mt-3">
                    ...
                    @error('emergency_contact')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                </div>
                @endif
            </div>
        </div>
