...
<form class="row g-2 mb-3">
    <div class="col-md-6">
        <input name="search" class="form-control" placeholder="Search name or specialization"
...
<div class="card p-3 table-responsive">
    <table class="table">
        ...
        @forelse($doctors as $d)<tr>
            ...
            <td>{{ $d->email ?: '-' }}</td>
            <td>
                <a href="{{ route('doctors.show',$d) }}" class="btn btn-sm btn-info">View</a> <a
                    href="{{ route('doctors.edit',$d) }}" class="btn btn-sm btn-warning">Edit</a>
